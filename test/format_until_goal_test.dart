  ...
  group('Test formatUntilGoal', () {
    for (final (goal, spent, forceSuffix, expected)
        in <(Duration, Duration, bool, String)>[
          (Duration(minutes: 30), Duration(minutes: 5), false, '25m'),
          (
          ...
          (Duration(hours: 0, minutes: 10), Duration(minutes: 5), false, '5m'),
          (
            Duration(hours: 1, minutes: 30),
            Duration(minutes: 5),
            true,
          ...
          (Duration(minutes: 1), Duration(minutes: 2), false, '+1m'),
          (Duration(minutes: 5), Duration(seconds: 30), false, "5m"),
          (Duration(minutes: 1), Duration(seconds: 30), false, "1m"),
          (Duration(minutes: 1), Duration(seconds: 60), false, "done"),
          (Duration(hours: 2), Duration(seconds: 5), false, "2h"),
          (Duration(hours: 2), Duration(seconds: 65), false, "1h59m"),
        ]) {
      test(
